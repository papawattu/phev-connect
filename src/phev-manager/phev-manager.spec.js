...
socketConnection.start.returns(Promise.resolve())
...
describe('Phev Manager', () => {
    ...
    it.skip('Should reject invalid message ', () => {        
    ...
    it.skip('Should start connect to host when start message received', () => {        
    ...
    it.skip('Should send valid message to client', () => {        
