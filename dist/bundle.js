...
var timeInterval_1 = __webpack_require__(61);
...
var QueueAction_1 = __webpack_require__(150);
...
var AsapAction_1 = __webpack_require__(302);
...
__webpack_require__(69).default().start();
...
var _phev_connect = __webpack_require__(70);

var _phev_connect2 = _interopRequireDefault(_phev_connect);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var App = function App(config) {

    var phevConnect = (0, _phev_connect2.default)(config);
...
var _phevMqtt = __webpack_require__(71);

var _phevMqtt2 = _interopRequireDefault(_phevMqtt);

var _rxjs = __webpack_require__(37);

var _net = __webpack_require__(356);

var _net2 = _interopRequireDefault(_net);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var logging = process.env.DEBUG ? true : false;
var carHost = process.env.CAR_HOST || '192.168.8.46';
var carPort = process.env.CAR_PORT || 8080;
var phevReceive = process.env.PHEV_RECEIVE || 'phev/receive';
var phevSend = process.env.PHEV_SEND || 'phev/send';
var mqttUsername = process.env.MQTT_USERNAME || '';
var mqttPassword = process.env.MQTT_PASSWORD || '';
var mqttUri = process.env.MQTT_URI || 'ws://secure.wattu.com:8080';

var log = function log(message) {
    return logging ? console.log(message) : undefined;
};

var PhevConnect = function PhevConnect() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        mqtt = _ref.mqtt;

    var client = new _net2.default.Socket();
    var phevMqtt = (0, _phevMqtt2.default)({ mqtt: mqtt, uri: mqttUri, options: { username: mqttUsername, password: mqttPassword } });

    var connect = function connect() {
        log('Connecting to ' + carHost + ':' + carPort);
        client.connect(carPort, carHost, function () {
            _rxjs.Observable.fromEvent(client, 'data').subscribe(function (data) {
    ...
    phevMqtt.messages(phevSend).subscribe(function (m) {
...
exports.stub_mqtt = undefined;

var _phev_mqtt = __webpack_require__(72);

var _phev_mqtt2 = _interopRequireDefault(_phev_mqtt);

var _mqtt_stub = __webpack_require__(354);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _phev_mqtt2.default;
exports.stub_mqtt = _mqtt_stub.stub_mqtt;
...
var _mqtt2 = __webpack_require__(73);
...
var PhevMqtt = function PhevMqtt(_ref) {
    ...
    client.on('connected', function () {
        return log('Connected to ' + uri);
    });
    client.on('error', function (err) {
        return log(err);
    });
    client.on('message', function (topic, msg) {
        return log('Received >> topic ' + topic + ' >> ' + JSON.stringify(msg));
    });
...
throw new Error("Module parse failed: /home/pi/phev-connect/node_modules/mqtt/mqtt.js Unexpected character '#' (1:0)\nYou may need an appropriate loader to handle this file type.\n| #!/usr/bin/env node\n| 'use strict'\n| ");
...
var Observable_1 = __webpack_require__(0);
var bindCallback_1 = __webpack_require__(76);
...
var BoundCallbackObservable_1 = __webpack_require__(77);
...
var Observable_1 = __webpack_require__(0);
var fromEvent_1 = __webpack_require__(99);
...
var FromEventObservable_1 = __webpack_require__(100);
...
var Observable_1 = __webpack_require__(0);
var fromEventPattern_1 = __webpack_require__(102);
...
var FromEventPatternObservable_1 = __webpack_require__(103);
...
var Observable_1 = __webpack_require__(0);
var generate_1 = __webpack_require__(107);
...
var Observable_1 = __webpack_require__(0);
var of_1 = __webpack_require__(125);
...
var Observable_1 = __webpack_require__(0);
var onErrorResumeNext_1 = __webpack_require__(127);
...
var Observable_1 = __webpack_require__(0);
var pairs_1 = __webpack_require__(129);
...
var PairsObservable_1 = __webpack_require__(130);
...
var Observable_1 = __webpack_require__(0);
var range_1 = __webpack_require__(132);
...
var RangeObservable_1 = __webpack_require__(133);
...
var Observable_1 = __webpack_require__(0);
var using_1 = __webpack_require__(135);
...
var UsingObservable_1 = __webpack_require__(136);
...
var Observable_1 = __webpack_require__(0);
var throw_1 = __webpack_require__(138);
...
var ErrorObservable_1 = __webpack_require__(139);
...
var Observable_1 = __webpack_require__(0);
var timer_1 = __webpack_require__(141);
...
var TimerObservable_1 = __webpack_require__(142);
...
var tryCatch_1 = __webpack_require__(8);
var errorObject_1 = __webpack_require__(6);
var assign_1 = __webpack_require__(152);
/**
 * We need this JSDoc comment for affecting ESDoc.
 * @extends {Ignored}
 * @hide true
...
var Observable_1 = __webpack_require__(0);
var buffer_1 = __webpack_require__(154);
...
var Observable_1 = __webpack_require__(0);
var bufferTime_1 = __webpack_require__(158);
...
var Observable_1 = __webpack_require__(0);
var bufferToggle_1 = __webpack_require__(160);
...
var Observable_1 = __webpack_require__(0);
var bufferWhen_1 = __webpack_require__(162);
...
var Observable_1 = __webpack_require__(0);
var concatMap_1 = __webpack_require__(172);
...
var Observable_1 = __webpack_require__(0);
var count_1 = __webpack_require__(176);
...
var Observable_1 = __webpack_require__(0);
var dematerialize_1 = __webpack_require__(178);
...
var Observable_1 = __webpack_require__(0);
var debounce_1 = __webpack_require__(180);
...
var Observable_1 = __webpack_require__(0);
var debounceTime_1 = __webpack_require__(182);
...
var Observable_1 = __webpack_require__(0);
var delay_1 = __webpack_require__(186);
...
var Observable_1 = __webpack_require__(0);
var distinct_1 = __webpack_require__(190);
...
var OuterSubscriber_1 = __webpack_require__(2);
var subscribeToResult_1 = __webpack_require__(3);
var Set_1 = __webpack_require__(191);
/**
...
var Observable_1 = __webpack_require__(0);
var first_1 = __webpack_require__(212);
...
var Observable_1 = __webpack_require__(0);
var shareReplay_1 = __webpack_require__(286);
...
var Observable_1 = __webpack_require__(0);
var single_1 = __webpack_require__(288);
...
var Observable_1 = __webpack_require__(0);
var skip_1 = __webpack_require__(290);
...
var Observable_1 = __webpack_require__(0);
var skipLast_1 = __webpack_require__(292);
...
var Observable_1 = __webpack_require__(0);
var startWith_1 = __webpack_require__(298);
...
var Observable_1 = __webpack_require__(0);
var subscribeOn_1 = __webpack_require__(300);
...
var SubscribeOnObservable_1 = __webpack_require__(301);
/**
...
var Immediate_1 = __webpack_require__(303);
var AsyncAction_1 = __webpack_require__(17);
/**
 * We need this JSDoc comment for affecting ESDoc.
 * @ignore
...
var Observable_1 = __webpack_require__(0);
var throttle_1 = __webpack_require__(60);
